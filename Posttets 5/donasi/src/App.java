...
public class App {
    ...
    public static void TambahDonasi(ArrayList<Donasi> dataDonasi, Scanner input) {
        try {
            ...
            Donasi donasi = new DonasiKesehatan(namaDonatur, jumlahDonasi, metodePembayaran, rumahSakitPenerima);
    ...
    public static void VerifikasiDonasi(ArrayList<Donasi> dataDonasi, Scanner input) {
        try {
            ...
            if (nomor < 1 || nomor > dataDonasi.size()) {
                ...
                // donasi.statusVerifikasi = true; // Tidak bisa diubah karena final
                System.out.println("Status verifikasi tidak bisa diubah karena bersifat final");
                System.out.print("Memproses");
                for (int i = 0; i < 3; i++) {
                    Thread.sleep(500);
                    System.out.print(".");
